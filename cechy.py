...
da = pd.read_csv('Acc_test.csv').drop(columns=["mag","lagX0","lagX1","lagX2","lagY0","lagY1","lagY2","lagZ0","lagZ1","lagZ2","Unnamed: 0"])
...
def feats_df(data):
    ...
    mpf_ = (*mpf(data),*iqr(data), *wilson_amp(data), *three_quarters(data), *one_quarter(data),
